...
<%
    ...
    Gson gson = new Gson();
    String produtoJson = (produto != null) ? gson.toJson(produto) : "null";
    String insumosJson = (insumos != null) ? gson.toJson(insumos) : "[]";
    String maosObraJson = (maosObra != null) ? gson.toJson(maosObra) : "[]";
%>
...
<body data-produto='<%= produtoJson %>' data-insumos='<%= insumosJson %>' data-maos-obra='<%= maosObraJson %>'>
	...
	<div class="inclusao-container">
	    ...
	    <div class="inclusao-body">
	        ...
	        <form id="produtoForm" action="${pageContext.request.contextPath}/empreendimento/produto/editar" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" id="precoVenda" name="precoVenda" min="0.01" value="${produto.precoVenda}" required>
                </div>
