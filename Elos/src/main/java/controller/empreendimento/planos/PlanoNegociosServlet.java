...
@WebServlet(urlPatterns = { "/empreendimento/plano-negocios" })
public class PlanoNegociosServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("/empreendimento/plano-negocios.jsp");
            rd.forward(request, response);
            
        } catch (Exception e) {
            logger.log(Level.SEVERE, "Erro ao carregar dados do Plano de Negócios para o empreendimento", e);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logger.log(Level.SEVERE, "Erro ao processar salvamento do Plano de Negócios", e);
        }
        
        response.sendRedirect(request.getContextPath() + "/empreendimento/plano-negocios");
    }
}