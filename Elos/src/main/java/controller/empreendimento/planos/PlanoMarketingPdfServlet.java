...
import jakarta.servlet.annotation.WebServlet; // <-- ALTERADO (só o path)
...
@WebServlet("/empreendimento/plano-marketing/pdf") // <-- ALTERADO
public class PlanoMarketingPdfServlet extends HttpServlet { // <-- ALTERADO
    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(PlanoMarketingPdfServlet.class.getName()); // <-- ALTERADO
    
    private QuestionarioDAO questionarioDAO = new QuestionarioDAO();
    private static final String NOME_QUESTIONARIO = "Plano de Marketing"; // <-- ALTERADO
    
    private static final String TEMPLATE_PATH = "/empreendimento/templates/questionario-template.html"; 

    public PlanoMarketingPdfServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.setHeader("Content-Disposition", "attachment; filename=\"plano_marketing.pdf\""); // <-- ALTERADO
            ...
            logger.log(Level.SEVERE, "Erro ao gerar PDF do Plano de Marketing", e); // <-- ALTERADO
