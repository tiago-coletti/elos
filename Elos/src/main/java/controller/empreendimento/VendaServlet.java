...
public class VendaServlet extends HttpServlet {
	...
	private void visualizarEdicao(HttpServletRequest request, HttpServletResponse response)
	    ...
	    try {
	        ...
	        Venda venda = vendaDAO.obterVendaPorId(compraId, empreendimentoId);
	...
	private void processarExclusao(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			boolean exclusao = vendaDAO.excluirVenda(compraId, empreendimentoId);
			if (exclusao) {
				mensagem = "Venda excluída com sucesso.";
			} else {
				mensagem = "Não foi possível excluir o venda.";
			}
