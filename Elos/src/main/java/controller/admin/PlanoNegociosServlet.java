...
@WebServlet(urlPatterns = { 
    "/admin/plano-negocios/listagem", 
    "/admin/plano-negocios/incluir",
    "/admin/plano-negocios/editar",
    "/admin/plano-negocios/excluir"
})
public class PlanoNegociosServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(PlanoNegociosServlet.class.getName());
    
    private QuestionarioDAO questionarioDAO = new QuestionarioDAO();
    private static final String NOME_QUESTIONARIO = "Plano de Negócios";
    private static final String URL_LISTAGEM = "/admin/plano-negocios/listagem";

    public PlanoNegociosServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (path) {
            case "/admin/plano-negocios/listagem":
                visualizarListagem(request, response);
                break;
            case "/admin/plano-negocios/incluir":
                visualizarInclusao(request, response);
                break;
            case "/admin/plano-negocios/editar":
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (path) {
            ...
            case "/admin/plano-negocios/editar":
                ...
                break;
            case "/admin/plano-negocios/excluir":
    ...
    private void visualizarListagem(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("/admin/plano-negocios/listagem.jsp");
    ...
    private void visualizarInclusao(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("/admin/plano-negocios/incluir.jsp");
            rd.forward(request, response);
    ...
    private void visualizarEdicao(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("/admin/plano-negocios/editar.jsp");
            rd.forward(request, response);
