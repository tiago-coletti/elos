...
<body>
    ...
    <header class="page-header">
        ...
        <c:url var="urlIncluir" value="/admin/plano-negocios/incluir">
                        ...
                        <c:forEach var="pergunta" items="${questionario.perguntas}">
                            <tr>
                                ...
                                <td class="action-cell">
                                    <c:url var="urlEditar" value="/admin/plano-negocios/editar">
                                    ...
                                    <form action="${pageContext.request.contextPath}/admin/plano-negocios/excluir" method="POST" style="display: inline;">
