...
<body>
	...
	<div class="inclusao-container">
	    ...
	    <div class="inclusao-body">
	        <h2>Inclusão de Insumo</h2>
	        
	        <form action="${pageContext.request.contextPath}/empreendimento/insumo/incluir" method="post">
	            <div class="form-group">
	                <label for="nome">Nome</label>
	                <input type="text" id="nome" name="nome" placeholder="Ex: Farinha de Trigo" required>
	            </div>
	            <div class="form-group">
	                <label for="unidadeMedida">Unidade de Medida</label>
	                <input type="text" id="unidadeMedida" name="unidadeMedida" placeholder="Ex: kg, L, m²" required>
	            </div>
