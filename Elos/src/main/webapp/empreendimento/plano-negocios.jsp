    ...
    <section class="inclusao-container">
        ...
        <div class="inclusao-body">
            ...
            <p style="margin-bottom: 30px; color: var(--grey-color);">
                Responda às perguntas abaixo para construir seu plano. Suas respostas são salvas automaticamente ao sair de cada campo.
            </p>
            
            <form id="form-questionario" action="${pageContext.request.contextPath}/empreendimento/plano-negocios" method="POST">
                ...
                <div class="form-actions" style="margin-top: 30px;">
                    <a href="${pageContext.request.contextPath}/empreendimento/plano-negocios/pdf" 
                       id="btnGerarPdf" 
                       class="btn-secondary" 
