...
<body>
	...
	<div class="inclusao-container">
	    ...
	    <div class="inclusao-body">
	        ...
	        <form action="${pageContext.request.contextPath}/empreendimento/mao-obra/editar" method="post">
	        	<input type="hidden" name="id" value="${maoObra.id}">
	        	<div class="form-group">
	                <label for="nome">Nome</label>
	                <input type="text" id="nome" name="nome" value="${maoObra.nome}" required>
	            </div>
				<div class="form-group">
